...
For a broader offline proof that also checks exact and upto replay rejection, batch corrective 402 state, idempotency, and tx-v1 claim/refund construction, run:
